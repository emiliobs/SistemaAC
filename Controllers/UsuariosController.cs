...
namespace SistemaAC.Controllers
{
    public class UsuariosController : Controller
    {
                                                ...
                                                ApplicationUser applicationUser)
        {
            ...
            //Ahora trabajamos con el objeto _userManager y le enviamos como parámetros
            //el objeto applicationUser y el password que se le asignará a ese usuario (recordemos que el password se ingresó en la ventana modal)
            //de esta manera se registra el usuario y se encripta su password
            var result = await _userManager.CreateAsync(applicationUser, passwordHash);
            //Ahora si vamos asignarle un rol, pero para esto vamos a validar que inicialmente se registre el usuario
            if (result.Succeeded)
            {
